...
@onready var V_ScnMapA01 = $Mp_1
@onready var V_ScnMapB01 = $Mp_2




func _init():	
	CLog=Cls_LogLine.new("Scn_0");
	CLog.V_Visible=true;
#END _init
...
func F_get_all_children(M_Node3D:Node3D):
	...
	for M_q in M_Lst.size():
		if(V.V_ClsActores.F_ADD_ByNode(M_Lst[M_q],Cls_Actor.eTipos.Suelo,true,1,"Desc")!=null):
